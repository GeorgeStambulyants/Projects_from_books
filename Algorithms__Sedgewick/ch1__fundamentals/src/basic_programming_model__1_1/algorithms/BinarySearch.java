/*
    class basic_programming_model__1_1.algorithms.BinarySearch must be tested with test data.
    ...
    Testing format after compilation:
        1) $ java basic_programming_model__1_1.algorithms.BinarySearch tinyW.txt < tinyT.txt
            output:
                50
                99
                13
        2) $ java basic_programming_model__1_1.algorithms.BinarySearch largeW.txt < largeT.txt
            output is very long and omitted here
 */
package basic_programming_model__1_1.algorithms;
